	...
	<body>
		<div id="controls">
			...
			<form action="/selection" method="post">
				<b>Time</b>
				<ul>
					<li>Earliest Departure : <input id="earliestReturnInput" type="date" name="bday"></li>
					<li>Latest Return : <input id="latestReturnInput" type="date" name="bday"></li>
					<li>Minimum stay : <input type="number" name="minimumStayInput" min="1" max="1000"></li>
					<li>Maximum stay : <input type="number" name="maximumStayInput" min="1" max="1000"></li>
				</ul>
...
func DisplayDataEntry(w http.ResponseWriter, r *http.Request, googleMapsApiCredentials string) {
	...
	t1 := template.New("Data entry template")
	t3, err := t1.Parse(dataEntryHtmlData)
